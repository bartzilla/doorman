 ...
 * });
 */
Application.prototype.createAccount = function createAccount(/* account, [options,] callback */) {
  var args = utils.resolveArgs(arguments, ['account', 'options', 'callback']);
  var applicationId = this.href;
  var tenantId = '58b961f6a973bc951a1f6890';

  request.post({headers: {'content-type': 'application/json'},
    url: 'http://localhost:8080/v1/tenants/' + tenantId + '/applications/' + applicationId + '/accounts',
    body: JSON.stringify(
      {
    ...
    function (err, data, body) {
      ...
      args.callback(null, new Account(href));
