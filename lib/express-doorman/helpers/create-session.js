...
module.exports = function (authenticationResult, account, req, res) {
  ...
  var doormanConfig = req.app.get('doormanConfig');
  ...
  if (authenticationResult.accessToken) {
    setTokenCookie(authenticationResult.accessToken, doormanConfig.web.accessTokenCookie);
  }

  if (authenticationResult.refreshToken) {
    setTokenCookie(authenticationResult.refreshToken, doormanConfig.web.refreshTokenCookie);
  }
};
