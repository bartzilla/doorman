 ...
 * @function
 *
 * @param {Object} doormanConfig - The express-stormpath configuration object
 * @param {Object} req - The http request.
 */
function applyDefaultAccountFields(doormanConfig, req) {
  var registerFields = doormanConfig.web.register.form.fields;
...
module.exports = function (req, res, next) {
  var application = req.app.get('doormanApplication');
  var config = req.app.get('doormanConfig');
  var logger = req.app.get('doormanLogger');
